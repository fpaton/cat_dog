...
setwd("~/Documents/Kaggle/CNN presentation/cat_images/reshape")
...
# Load datasets
setwd("~/Documents/Kaggle/CNN presentation/cat_images/reshape")
cats <- read.csv("cats_10")
setwd("/Users/Forrest/Documents/Kaggle/CNN presentation/dog_images/reshaped")
dogs <- read.csv("dogs_10")

# Bind rows in a single dataset
new <- rbind(cats, dogs)

# Shuffle new dataset
shuffled <- new[sample(1:20), ]

# Train-test split
train_28 <- shuffled[1:10, ]
test_28 <- shuffled[11:20, ]
